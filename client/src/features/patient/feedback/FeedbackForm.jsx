				...
				<div className="flex flex-wrap gap-2">
					{FEEDBACK_LEVELS.map((level) => (
						<button
							...
							className={`flex-1 min-w-[120px] rounded-2xl border px-3 py-2 text-xs font-semibold uppercase tracking-[0.3em] transition ${
								Number(formState.rating) === level.value
